            ...
            <div class="col-lg-6">
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-success text-white py-3">
                        <h5 class="mb-0"><i class="bi bi-plus-circle me-2"></i>Form Tambah Laporan Penjualan</h5>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('laporan-penjualan.store') }}" method="POST">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <select id="bulan" name="bulan" class="form-select @error('bulan') is-invalid @enderror" required>
                                        ...
                                        <option value="1" @selected(old('bulan') == 1)>Januari</option>
                                        <option value="2" @selected(old('bulan') == 2)>Februari</option>
                                        <option value="3" @selected(old('bulan') == 3)>Maret</option>
                                        <option value="4" @selected(old('bulan') == 4)>April</option>
                                        <option value="5" @selected(old('bulan') == 5)>Mei</option>
                                        <option value="6" @selected(old('bulan') == 6)>Juni</option>
                                        <option value="7" @selected(old('bulan') == 7)>Juli</option>
                                        <option value="8" @selected(old('bulan') == 8)>Agustus</option>
                                        <option value="9" @selected(old('bulan') == 9)>September</option>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" id="tahun" name="tahun" 
                                           ...
                                           placeholder="2026" value="{{ old('tahun', date('Y')) }}" 
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" id="total_sepatu_terjual" name="total_sepatu_terjual" 
                                           ...
                                           placeholder="0" value="{{ old('total_sepatu_terjual') }}" min="0" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" id="total_omset" name="total_omset" 
                                           ...
                                           placeholder="0" value="{{ old('total_omset') }}" 
                            ...
                            <div class="alert alert-info mb-4" role="alert">
                                ...
                                <small>Pastikan data bulan dan tahun belum ada di database sebelum menambahkan laporan baru.</small>
                            </div>
